 ...
 * @author sanda
 */
public class DiscountAllProductsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int perc=Integer.parseInt(request.getParameter("disc-all-per"));
            boolean res=ProductDAO.discountAllAt( perc);
            if(res)
